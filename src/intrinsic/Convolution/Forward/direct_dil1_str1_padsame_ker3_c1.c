...
//  const int64_t inChannelGroup  = inChannel  / group;   // equal to pDataKernel->inChannel ( must be 1 )
...

  {
	...
	const int64_t kernGroupOffset = g * outChannelOffset * kernHeight * kernWidth;
...
{								\
  ...
  _vel_vstl_vssl(vrsum, 4, pOut+outIndex+ ((N)+1)*oPixels, vl) ;	\
	    ...
	    FILTER_R3S3(0UL, 0) ; pKerValue += 18 ;
#undef FILTER_R3S3
...
{								\
  ...
  _vel_vstl_vssl(vrsum, 4, pOut+outIndex+ ((N)+1)*oPixels, vl) ;	\
	    ...
	    FILTER_R3S3(0UL, 0) ; pKerValue += 18 ;
	    FILTER_R3S3(0UL, 2) ; pKerValue += 18 ;
#undef FILTER_R3S3
	  } // outPixels
...
{								\
  ...
  _vel_vstl_vssl(vrsum, 4, pOut+outIndex+ ((N)+1)*oPixels, vl) ;	\
	    ...
	    FILTER_R3S3(0UL, 0) ; pKerValue += 18 ;
	    FILTER_R3S3(0UL, 2) ; pKerValue += 18 ;
	    FILTER_R3S3(0UL, 4) ; pKerValue += 18 ;
	    FILTER_R3S3(0UL, 6) ; pKerValue += 18 ;
#undef FILTER_R3S3
	  } // outPixels
	  k+=8 ;
	}
...
{								\
  ...
  _vel_vstl_vssl(vrsum, 4, pOut+outIndex+ ((N)+1)*oPixels, vl) ;	\
	    ...
	    FILTER_R3S3(0UL, 4) ; pKerValue += 18 ;
	    FILTER_R3S3(0UL, 6) ; pKerValue += 18 ;
	    FILTER_R3S3(0UL, 8) ; pKerValue += 18 ;
	    FILTER_R3S3(0UL, 10) ; pKerValue += 18 ;
	    FILTER_R3S3(0UL, 12) ; pKerValue += 18 ;
	    FILTER_R3S3(0UL, 14) ; pKerValue += 18 ;
